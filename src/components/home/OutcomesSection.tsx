...
const outcomes = [
  ...
  'Заниматься интересным делом, которое приносит удовольствие и достойный доход.',
  'Получить работу с высокой зарплатой и перспективами карьерного роста.',
  'Повысить качество жизни и реализовать свои профессиональные амбиции.',
      ...
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold md:text-4xl">
            Успех близко — сделайте шаг навстречу
          </h2>
